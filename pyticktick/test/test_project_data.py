...
from pyticktick.models.project_data import ProjectData  # noqa: E501
...
class TestProjectData(unittest.TestCase):
	...
	def make_instance(self, include_optional) -> ProjectData:
        ...
        if include_optional:
            return ProjectData(
                project = pyticktick.models.project.Project(
                    id = '', 
                    name = '', 
                    color = '', 
                    sort_order = 56, 
                ...
                columns = [
                    pyticktick.models.column.Column(
                        id = '', 
                        project_id = '', 
                        name = '', 
                        sort_order = 56, )
