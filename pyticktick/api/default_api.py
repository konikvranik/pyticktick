...
class DefaultApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method oauth_token_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    async def open_v1_project_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method open_v1_project_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    async def open_v1_project_post_with_http_info(self, project : Project, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method open_v1_project_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    async def open_v1_project_project_id_data_get(self, project_id : Annotated[StrictStr, Field(..., description="Project identifier")], **kwargs) -> ProjectData:  # noqa: E501
    ...
    async def open_v1_project_project_id_data_get_with_http_info(self, project_id : Annotated[StrictStr, Field(..., description="Project identifier")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method open_v1_project_project_id_data_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    async def open_v1_project_project_id_delete_with_http_info(self, project_id : Annotated[StrictStr, Field(..., description="Project identifier")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method open_v1_project_project_id_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    async def open_v1_project_project_id_get(self, project_id : Annotated[StrictStr, Field(..., description="Project identifier")], **kwargs) -> Project:  # noqa: E501
    ...
    async def open_v1_project_project_id_get_with_http_info(self, project_id : Annotated[StrictStr, Field(..., description="Project identifier")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method open_v1_project_project_id_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    async def open_v1_project_project_id_post(self, project_id : Annotated[StrictStr, Field(..., description="Project identifier")], open_v1_project_project_id_post_request : OpenV1ProjectProjectIdPostRequest, **kwargs) -> Project:  # noqa: E501
    ...
    async def open_v1_project_project_id_post_with_http_info(self, project_id : Annotated[StrictStr, Field(..., description="Project identifier")], open_v1_project_project_id_post_request : OpenV1ProjectProjectIdPostRequest, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method open_v1_project_project_id_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    async def open_v1_project_project_id_task_task_id_get(self, project_id : Annotated[StrictStr, Field(..., description="Project identifier")], task_id : Annotated[StrictStr, Field(..., description="Task identifier")], **kwargs) -> Task:  # noqa: E501
    ...
    async def open_v1_task_post_with_http_info(self, task : Task, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method open_v1_task_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    async def open_v1_task_task_id_post(self, task_id : Annotated[StrictStr, Field(..., description="Task identifier")], open_v1_task_task_id_post_request : OpenV1TaskTaskIdPostRequest, **kwargs) -> Task:  # noqa: E501
        """Update Task  # noqa: E501
    ...
    async def open_v1_task_task_id_post_with_http_info(self, task_id : Annotated[StrictStr, Field(..., description="Task identifier")], open_v1_task_task_id_post_request : OpenV1TaskTaskIdPostRequest, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method open_v1_task_task_id_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
