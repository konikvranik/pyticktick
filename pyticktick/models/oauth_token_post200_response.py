...
class OauthTokenPost200Response(BaseModel):
	...
	@classmethod
	def from_json(cls, json_str: str) -> OauthTokenPost200Response:
	...
	@classmethod
	def from_dict(cls, obj: dict) -> OauthTokenPost200Response:
		"""Create an instance of OauthTokenPost200Response from a dict"""
		if obj is None:
			return None

		if not isinstance(obj, dict):
			return OauthTokenPost200Response.parse_obj(obj)

		_obj = OauthTokenPost200Response.parse_obj({"access_token": obj.get("access_token")})
