...
class Task(BaseModel):
	...
	completed_time: Optional[datetime] = Field(
		default=None, alias="completedTime", description="Task completed time in \"yyyy-MM-dd'T'HH:mm:ssZ\""
	)
	...
	due_date: Optional[datetime] = Field(
		default=None, alias="dueDate", description="Task due date time in \"yyyy-MM-dd'T'HH:mm:ssZ\""
	)
	...
	start_date: Optional[datetime] = Field(
		default=None, alias="startDate", description="Start date time in \"yyyy-MM-dd'T'HH:mm:ssZ\""
	)
		...
		_obj = Task.parse_obj(
			{
				...
				"items": [ChecklistItem.from_dict(_item) for _item in obj.get("items")]
