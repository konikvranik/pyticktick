...
class ChecklistItem(BaseModel):
	...
	status: Optional[Status] = Field(default=None, description="The completion status of subtask")
	completed_time: Optional[datetime] = Field(
		default=None, alias="completedTime", description="Subtask completed time in \"yyyy-MM-dd'T'HH:mm:ssZ\""
	)
	...
	start_date: Optional[datetime] = Field(
		default=None, alias="startDate", description="Subtask start date time in \"yyyy-MM-dd'T'HH:mm:ssZ\""
	)
	time_zone: Optional[StrictStr] = Field(default=None, alias="timeZone", description="Subtask timezone")
