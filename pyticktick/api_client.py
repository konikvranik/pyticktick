...
from pyticktick.configuration import Configuration
from pyticktick.api_response import ApiResponse
import pyticktick.models
from pyticktick import rest
from pyticktick.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pyticktick.models, klass)
